...
function hanoi(n,fromTour,toTour,auxTour){
    if(n===0){
        return;
    }
    hanoi(n-1,fromTour,auxTour,toTour);
    console.log(`Déplace le disque ${n} de ${fromTour} à ${toTour}.`);
    hanoi(n-1,auxTour,toTour,fromTour);
}
